    ...
    <div class="product-edit-card">
        <div class="card-header">
            <div class="header-content">
                ...
                <p class="subtitle">Update the details of your product</p>
            </div>
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data" id="product-edit-form">
                @csrf
                @method('PUT')
                        ...
                        <div class="image-upload-container">
                            <label for="image" class="upload-label">
                                <div class="upload-preview" id="image-preview">
                                    @if($product->image)
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="Current product image" class="preview-image">
                                    @else
